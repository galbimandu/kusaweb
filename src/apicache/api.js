...
export async function uploadImage(file_path, bucket_path, options=undefined, bucket = 'kusaweb-bucket') {
...
export async function uploadUserProfileImage(file_path) {
    ...
    const bucket_path = `user_images/test-id12312321.${file_path.split('.').pop()}`;
