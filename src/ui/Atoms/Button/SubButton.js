...
export const SubButton = styled(Button)`
  border-color: ${({ theme }) => theme.colors.color_state_warning_light};
  ...
  &:focus {
    border-color: ${({ theme }) =>
      theme.colors.color_state_warning_light} !important;
  ...
  &:hover {
    border-color: ${({ theme }) =>
      theme.colors.color_state_warning_middle} !important;
    background-color: ${({ theme }) =>
      theme.colors.color_state_warning_middle} !important;
  }
`;
